...
const { imageProcessingMiddleware } = require("../middlewares/multer")
...
booksRouter.post("/", authMdlle, upload.single("image"), imageProcessingMiddleware, booksCtrl.postBook);// Route pour ajouter un nouveau livre
